...
docker run --rm -p 4173:4173 ghcr.io/bodencrouch/cloudflare-one-gui-linux:latest
```
...
```bash
brew tap bodencrouch/cloudflare-one-gui-linux https://github.com/bodencrouch/cloudflare-one-gui-linux.git homebrew-tap
